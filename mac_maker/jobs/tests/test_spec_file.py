...
class TestSpecFileJob:
  ...
  def test_initialize__has_correct_attributes(
    ...
    assert spec_file_job_instance.spec_file_content is None
  ...
  def test_get_state__returns_correct_value(
    ...
    assert results == mocked_spec_file_extractor_instance \
        .get_spec_file_data.return_value['spec_file_content']
  ...
  def test_get_state__calls_echo(
    ...
    assert mocked_click_echo.mock_calls == [
        ...
        mock.call(
            mocked_spec_file_extractor_instance.get_spec_file_data.
