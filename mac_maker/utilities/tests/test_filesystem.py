...
class TestFileSystem(TestCase):
  ...
  def test_get_state_file_str(self) -> None:
    self.assertEqual(
  ...
  def test_get_inventory_file_str(self) -> None:
    self.assertEqual(
  ...
  def test_get_galaxy_requirements_file_str(self) -> None:
    expected_path = (
        self.mock_root / config.PROFILE_FOLDER_PATH /
  ...
  def test_get_playbook_str(self) -> None:
    self.assertEqual(
  ...
  def test_get_profile_data_path_str(self) -> None:
    self.assertEqual(
  ...
  def test_get_roles_path_str(self) -> None:
    self.assertEqual(
  ...
  def test_get_collections_path_str(self) -> None:
    self.assertEqual(
